class Urls:
    ...
    RECOVERY_PAGE = f'{MAIN_URL}/forgot-password'
    RESET_PASSWORD_PAGE = f'{MAIN_URL}/reset-password'
    FEED_PAGE = ORDER_FEED_URL
    ...
    PERSONAL_ACCOUNT = f'{ACCOUNT_URL}/profile'
    ORDER_HISTORY_URL = f'{ACCOUNT_URL}/order-history'
    ORDER_HISTORY = f'{ACCOUNT_URL}/order-history'
